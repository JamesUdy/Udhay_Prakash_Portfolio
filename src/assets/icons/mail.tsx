const mail = () => {
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className="w-4 lg:w-6 h-4 lg:h-6 group"
    >
      <polygon
        className="fill-white group-hover:fill-[#23cbeca7] ease-in duration-200"
      ...
      ></path>
      <polygon className="fill-none" points="486 116.4 486 382.6 319 248.9 386.6 195.2"></polygon>
      <polygon className="fill-none" points="193 248.9 26 382.6 26 116.4 125.4 195.2"></polygon>
      <polygon
        className="fill-none"
