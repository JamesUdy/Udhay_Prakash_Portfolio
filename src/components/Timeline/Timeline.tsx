        ...
        <div className="git-main">
          ...
          <div className="git-footer-jokes">
            <p className="git-joke-line">
              <span className="git-joke-label">warning:</span> <TeaCupCount /> cups of tea consumed.
              no refunds.
            </p>
            <p className="git-joke-line">
              <span className="git-joke-label">note:</span> no rubber ducks were harmed during
              debugging.
            </p>
            <p className="git-joke-line">
              <span className="git-joke-label">fun fact:</span> 99% of bugs fixed by turning it off
              and on again.
            </p>
            <p className="git-joke-line git-joke-line--muted">— end of git log —</p>
          </div>
        </div>
      </div>
    </section>
