...
const ProjectCard = (project) => {
    ...
    return (
        <motion.div variants={fadeIn("up","spring",project.index*0.5,0.75)}>
            ...
            }} className="work-card-bg p-5 rounded-2xl sm:w-[360px] w-full h-full">
                <div className="relative w-full">
                    <img src={project.image} alt={project.title} className="w-full h-[200px] object-full rounded-2xl" />
                    <div className="absolute inset-0 flex justify-between flex-row  m-3">
                        <div className="mt-1">
