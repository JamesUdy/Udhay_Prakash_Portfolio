        ...
        <div className="git-card-head">
          <div className="git-refs">
            ...
            <span
              ...
              style={{ '--bc': commit.color } as React.CSSProperties}
            >
              <svg
                viewBox="0 0 16 16"
                fill="currentColor"
            ...
            {(() => {
              const m = TYPE_META[commit.typeBadge];
              return m ? (
                <span className="git-type-badge" style={{ '--tc': m.color } as React.CSSProperties}>
                  {m.label}
                </span>
              ) : null;
            })()}
            ...
            >
              <div className="git-body-inner">
                <div className="git-diff-header">
                  ...
                  <span className="git-diff-range">
                    @@ -{index + 1},0 +{index + 1},{commit.body.length} @@
                  </span>
                </div>
...
export function FutureCommit({ svgW }: { svgW: number }) {
  ...
  return (
    <motion.div
      ref={ref}
      className="git-row git-row--future"
      initial={{ opacity: 0, x: -28 }}
      animate={inView ? { opacity: 1, x: 0 } : {}}
    ...
    >
      <div className="git-card git-card--future">
        <div className="git-card-head">
          <div className="git-refs">
            <span className="git-sha" style={{ opacity: 0.45 }}>
              {FUTURE.sha}
            </span>
            <span className="git-branch-badge git-branch-badge--future">{FUTURE.branch}</span>
          </div>
          <span className="git-date" style={{ opacity: 0.45 }}>
            {FUTURE.date}
          </span>
        </div>
